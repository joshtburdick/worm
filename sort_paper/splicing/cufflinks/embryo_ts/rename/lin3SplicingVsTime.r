...
r = read.tsv("git/sort_paper/splicing/cufflinks/embryo_ts/rename/groupedIsoforms.tsv")

times = as.numeric(rownames(r))

pdf("git/sort_paper/splicing/cufflinks/embryo_ts/rename/lin3SplicingVsTime.pdf")
