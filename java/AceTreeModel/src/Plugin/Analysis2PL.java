...
import org.rhwlab.snight.Identity3;   // jtb
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class Analysis2PL extends Log implements Runnable {
    AceTree         iAceTree;
    ...
    public Analysis2PL(String title) {
        super(title);
        showMe();
        JButton jb = null;
    ...
    private void lineageAngle() {
        ...
        JPlotLayout plotLayout = plotlayout(f.getName(), xLabel, yLabel, pd.xValues, pd.yValues);
...
/*
    ...
    private void test5() {
        ...
        identity.setNamingMethod(Identity.NEWCANONICAL);
