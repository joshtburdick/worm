 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class Image3D2Z  extends MouseAdapter
    ...
    public class Nuclei3D {
        ...
        private Nucleus addOne(String name, boolean sister) {
            ...
            iShowIt = true;
            iTransparent = false;
            if (k < iDispProps2Z.length - 2) app = getLineageColor(k);
    ...
    public class PropertiesTab3 implements ActionListener {
        ...
        public PropertiesTab3(Image3D2Z parent) {
            ...
            //println("PropertiesTab2, " + iDisprops2Z);
        ...
        private void saveToFile() {
            ...
            try {
                ...
                for (int i=0; i < iDispProps2Z.length - 2; i++) {
                    //pw.println(iDisprops2Z[i].iName + CS + COLORS[iDisprops2Z[i].iLineageNum]);
                    StringBuffer sb = new StringBuffer();
                    sb.append("<lineage ");
        ...
        public class SublineageUI {
            ...
            public SublineageUI(int i) {
                ...
                String [] list;
                list = COLORS;
                if (i == iDispProps2Z.length - 2) list = TRANSPROPS;
                else if (i == iDispProps2Z.length - 1) list = GRAYDEPTH;
