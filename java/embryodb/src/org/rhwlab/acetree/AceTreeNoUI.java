...
public class AceTreeNoUI {
    ...
    public int bringUpSeriesData(Config config) {
        ...
        iNucleiMgr = new NucleiMgr(config, iPrintWriter);
   ...
   ;
	...
	public static void main(String[] args) {
		...
		/*
		acenui.updateDisplay(200, 15, 0);
		//acenui.test();
		println("AceTreeNoUI.main, ");
        JFrame frame = new JFrame("LabelDemo");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(1000,1000);
        BufferedImage bi = acenui.getImageWindowNoUI().createBufferedImage();
