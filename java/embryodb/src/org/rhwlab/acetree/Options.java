...
public class Options extends JDialog implements ActionListener {
    ...
    private void addIdentityChoices(JPanel mp) {
        ...
        iStandard.setSelected(iNamingMethod == Identity.STANDARD);
        //iCanonical.setSelected(iNamingMethod == Identity.CANONICAL);
        iNewCanonical.setSelected(iNamingMethod == Identity.NEWCANONICAL);
        iManual.setSelected(iNamingMethod == Identity.MANUAL);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (x != iCancel) {
            ...
            int namingMethod = Identity.MANUAL;
            if (iStandard.isSelected()) namingMethod = Identity.STANDARD;
            //else if (iCanonical.isSelected()) namingMethod = Identity.CANONICAL;
            else if (iNewCanonical.isSelected()) namingMethod = Identity.NEWCANONICAL;
...
// jtb: omitting to allow switching between channels quickly
//        dispose();
