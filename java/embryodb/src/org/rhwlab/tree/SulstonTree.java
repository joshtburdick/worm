...
public class SulstonTree extends JFrame implements ActionListener, WindowFocusListener {
    ...
    public SulstonTree(Object tree, String title, Cell c, boolean canInterrogate) {
        ...
        jp.add(rootCell);
        iRootCell = new JTextField(c.getName(), 10);
        jp.add(iRootCell);
        iToolBar.add(jp);
        ...
        // jtb: setting this fairly arbitrarily
        // ??? is this an appropriate number?
        int endTimeData = iCurrentCell.getEndTime()+50;
        ...
        jp = new JPanel(new FlowLayout());
        iMinRedField = new JTextField("-500", 7);
