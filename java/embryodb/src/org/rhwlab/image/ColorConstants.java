...
Color3f(0.0f,0.0f,1.0f);
    ...
    public static final Color3f orange  = new
    Color3f(1.0f,.5f,0.0f);
...
Color3f(1.0f,1.0f,1.0f);
    ...
    public static final Color3f gray   =
        new Color3f(((float)Color.gray.getRed())/256,
                    ((float)Color.gray.getGreen())/256,
                    ((float)Color.gray.getBlue())/256);
    public static final Color3f pink   =
        new Color3f(((float)Color.pink.getRed())/256,
